...
tc_ts_map = {
    ...
    7:      [ts_email.TsEmail,"tc_dummy",0],
    8:      [ts_email.TsEmail,"tc_dummy",0],
    9:      [ts_email.TsEmail,"tc_dummy",0],
    10:     [ts_email.TsEmail,"tc_dummy",0],     
    11:     [ts_email.TsEmail,"tc_dummy",0],           
    12:     [ts_email.TsEmail,"tc_dummy",0],                
    13:     [ts_email.TsEmail,"tc_dummy",0],           
    14:     [ts_email.TsEmail,"tc_dummy",0],           
    15:     [ts_email.TsEmail,"tc_dummy",0],           
    16:     [ts_email.TsEmail,"tc_dummy",0],         
    17:     [ts_email.TsEmail,"tc_dummy",0],          
    18:     [ts_email.TsEmail,"tc_dummy",0],           
    19:     [ts_email.TsEmail,"tc_dummy",0],           
    20:     [ts_email.TsEmail,"tc_dummy",0],           
