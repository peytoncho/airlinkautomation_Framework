...
from sftp import SFTPError, BaseSFTP, SFTP_OK, SFTP_EOF, SFTP_NO_SUCH_FILE, \
    SFTP_PERMISSION_DENIED, SFTP_FAILURE, SFTP_BAD_MESSAGE, SFTP_NO_CONNECTION, \
    SFTP_CONNECTION_LOST, SFTP_OP_UNSUPPORTED
